...
apt-get install -y build-essential automake gettext re2c pkg-config \
        ...
        libpng12-dev libjpeg-dev libmcrypt-dev libtidy-dev \
        libxslt1-dev libpcre3-dev liblzma-dev unixodbc-dev \
        libcurl4-openssl-dev libexpat1-dev \
        libncurses5-dev libncursesw5-dev tk8.6 libreadline5-
